...
const content = {
  en: {
    ...
    values: [
      ["🤝", "Human Dignity", "Every person deserves respect, safety, and the freedom to live without humiliation or fear."],
      ["🧭", "Freedom of Conscience", "People should be able to believe, not believe, question, and think without coercion."],
      ["🧠", "Critical Thinking", "We value reason, honest inquiry, and the courage to examine ideas carefully."],
      ["💬", "Peaceful Dialogue", "Difficult questions need calm conversations, not hostility or fear."],
      ["👥", "Solidarity", "No one should feel alone because of their convictions or search for meaning."],
      ["⚖️", "Responsibility", "Freedom becomes stronger when it is joined with care, ethics, and responsibility toward others."],
    ],
    ...
    building: [
      ["✨", "Humanistic Resources", "We are developing educational and reflective Arabic-language content on humanist ethics, dignity, critical thinking, and meaning."],
      ["🛡️", "Safe Community", "We aim to build a future privacy-conscious space where thoughtful Syrians can connect, reflect, and support each other carefully."],
      ["💬", "Dialogue and Reflection", "We are shaping formats for constructive conversations about ethics, identity, belonging, human rights, and personal responsibility."],
      ["🌍", "Freedom of Conscience", "We hope to support awareness and careful documentation around the right to believe, not believe, question, and think freely."],
    ],
    ...
    faqs: [
      ["What is Syrian Humanists?", "Syrian Humanists is an independent initiative in development. It aims to create a safe, humane, and intellectually honest space for Syrians who value dignity, freedom of conscience, critical thinking, and peaceful coexistence."],
      ["Is this a political project?", "No. The initiative is not built as a political campaign or party. Its focus is human dignity, conscience, ethical reflection, and safe dialogue."],
      ["Is this an anti-religion project?", "No. Syrian Humanists respects both belief and non-belief. It does not exist to attack religious people, but to support freedom of conscience and humane coexistence."],
      ["Who is it for?", "It is mainly for Syrians and Arabic-speaking free thinkers who feel the need for thoughtful resources, careful conversation, and a more humane ethical language."],
      ["Is the project already registered?", "Not yet. It is currently in feasibility study and concept development, with legal and organizational groundwork being prepared for a responsible future structure."],
      ["How can someone contribute or connect?", "At this stage, the most valuable contribution is thoughtful feedback, practical advice, careful collaboration, and respectful conversation about direction and viability."],
    ],
    ...
    needs: ["Honest human feedback", "Practical advice", "Thoughtful conversations", "Questions that should be faced before growth"],
  ...
  ar: {
    ...
    values: [
      ["🤝", "الكرامة الإنسانية", "كل إنسان يستحق الاحترام، الأمان، والقدرة على العيش بلا إهانة أو خوف."],
      ["🧭", "حرية الضمير", "من حق الإنسان أن يؤمن، أو لا يؤمن، أو يسأل ويفكر بلا إكراه."],
      ["🧠", "التفكير النقدي", "نقدّر العقل، السؤال الصادق، والشجاعة في فحص الأفكار بهدوء."],
      ["💬", "الحوار السلمي", "الأسئلة الصعبة تحتاج حواراً هادئاً، لا عداءً ولا خوفاً."],
      ["👥", "التضامن", "لا ينبغي أن يشعر أحد أنه وحيد بسبب قناعاته أو بحثه عن المعنى."],
      ["⚖️", "المسؤولية", "تصبح الحرية أقوى عندما ترتبط بالعناية، الأخلاق، والمسؤولية تجاه الآخرين."],
    ],
    ...
    building: [
      ["✨", "موارد إنسانية", "نعمل على تطوير محتوى عربي تعليمي وتأملي حول الأخلاق الإنسانية، الكرامة، التفكير النقدي، والمعنى."],
      ["🛡️", "مجتمع آمن", "نطمح إلى بناء مساحة مستقبلية تراعي الخصوصية، يستطيع السوريون فيها التواصل والتفكير والدعم المتبادل بحذر."],
      ["💬", "حوار وتأمل", "نعمل على صياغة مساحات حوار بناءة حول الأخلاق، الهوية، الانتماء، حقوق الإنسان، والمسؤولية الشخصية."],
      ["🌍", "حرية الضمير", "نسعى إلى دعم الوعي والتوثيق الحذر حول الحق في الإيمان، عدم الإيمان، السؤال، والتفكير الحر."],
    ],
    ...
    faqs: [
      ["ما هي مبادرة الإنسانيين السوريين؟", "هي مبادرة مستقلة قيد التطوير، تهدف إلى بناء مساحة آمنة، إنسانية، وصادقة فكرياً للسوريين الذين يقدّرون الكرامة، حرية الضمير، التفكير النقدي، والتعايش السلمي."],
      ["هل هذا مشروع سياسي؟", "لا. المبادرة ليست حزباً أو حملة سياسية. تركيزها الأساسي هو الكرامة الإنسانية، الضمير، التأمل الأخلاقي، والحوار الآمن."],
      ["هل هي مبادرة ضد الدين؟", "لا. المبادرة تحترم الإيمان وعدم الإيمان. وجودها ليس لمهاجمة المتدينين، بل لدعم حرية الضمير والتعايش الإنساني."],
      ["لمن هذه المبادرة؟", "هي بالأساس للسوريين والناطقين بالعربية من أصحاب التفكير الحر الذين يحتاجون إلى موارد هادئة، حوار آمن، ولغة أخلاقية أكثر إنسانية."],
      ["هل المبادرة مسجلة رسمياً؟", "ليس بعد. هي حالياً في مرحلة دراسة الجدوى وتطوير المفهوم، مع التفكير في الأسس القانونية والتنظيمية المناسبة للمستقبل."],
      ["كيف يمكن المساهمة أو التواصل؟", "في هذه المرحلة، أهم مساهمة هي الملاحظات الصادقة، النصيحة العملية، التعاون الحذر، والحوار المحترم حول الاتجاه والجدوى."],
    ],
    ...
    needs: ["ملاحظات إنسانية صادقة", "نصائح عملية", "حوارات هادئة", "أسئلة يجب مواجهتها قبل التوسع"],
    ...
    >
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 lg:px-8">
          ...
          <nav className="hidden items-center gap-8 lg:flex">
            {copy.nav.map(([label, href]) => (
              <a key={href} href={href} className="text-sm font-semibold text-[#14232B]/70 transition hover:text-[#195C85]">
                {label}
              </a>
            ))}
          </nav>
          ...
          <div className="hidden items-center gap-4 lg:flex">
            ...
            <Button href="#contact" isAr={isAr}>{copy.cta}</Button>
          </div>
        ...
        {menuOpen && (
          <div className="border-t border-[#195C85]/10 bg-white px-5 py-5 lg:hidden">
            <div className="flex flex-col gap-4">
              {copy.nav.map(([label, href]) => (
                <a key={href} href={href} onClick={() => setMenuOpen(false)} className="font-semibold text-[#14232B]/80">
                  {label}
                </a>
              ))}
              <LanguageToggle lang={lang} setLang={setLang} />
      ...
      <main id="top">
          ...
          <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
            <div className={align}>
              ...
              <div className="mt-9 flex flex-col gap-4 sm:flex-row">
                <Button href="#about" isAr={isAr}>{copy.learnMore}</Button>
                <Button href="#contact" variant="secondary" isAr={isAr}>{copy.support}</Button>
              </div>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
              <div className={align}>
                ...
                <h2 className="text-4xl font-black tracking-tight text-[#195C85] md:text-5xl">{copy.aboutTitle}</h2>
              </div>
              ...
              <div className="rounded-[2.5rem] border border-[#195C85]/10 bg-white p-8 shadow-sm md:p-10">
                ...
                <div className="mt-8 grid gap-4 sm:grid-cols-3">
                  {copy.aboutCards.map(([title, text]) => (
                    <div key={title} className="rounded-2xl bg-[#F8FAF7] p-4 ring-1 ring-[#7CCBAE]/25">
                      <p className="text-xs font-bold uppercase tracking-[0.16em] text-[#25A77A]">{title}</p>
                      <p className="mt-2 text-sm font-bold leading-6 text-[#14232B]">{text}</p>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <section className="px-5 py-20 lg:px-8">
          <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-2">
            ...
            <div className="rounded-[2.5rem] border border-[#25A77A]/20 bg-white p-8 shadow-sm md:p-10">
              ...
              <h2 className="text-3xl font-black text-[#14232B] md:text-4xl">{copy.whyTitle}</h2>
        ...
        <section id="values" className="px-5 py-20 lg:px-8">
          <div className="mx-auto max-w-7xl">
            <div className="mx-auto mb-12 max-w-3xl text-center">
              ...
              <h2 className="text-4xl font-black tracking-tight text-[#14232B] md:text-5xl">{copy.valuesTitle}</h2>
              <p className="mt-5 text-lg leading-8 text-[#14232B]/70">{copy.valuesText}</p>
            </div>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
              <div className={align}>
                ...
                <h2 className="text-4xl font-black tracking-tight text-[#195C85] md:text-5xl">{copy.buildingTitle}</h2>
              </div>
          ...
          <div className="mx-auto max-w-7xl rounded-[3rem] border border-[#195C85]/10 bg-white p-8 shadow-sm md:p-12">
            <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr]">
              <div className={align}>
                ...
                <h2 className="text-4xl font-black tracking-tight text-[#14232B] md:text-5xl">{copy.principlesTitle}</h2>
              </div>

              <div className="grid gap-4 sm:grid-cols-2">
                {copy.principles.map((item) => (
                  <div key={item} className="flex items-start gap-3 rounded-2xl bg-[#F8FAF7] p-4 ring-1 ring-[#7CCBAE]/25">
        ...
        <section className="px-5 py-20 lg:px-8">
          <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-2">
            <div className="rounded-[2.5rem] border border-[#195C85]/10 bg-white p-8 shadow-sm md:p-10">
              <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-[#195C85] text-2xl text-white">🔐</div>
              <h2 className="text-3xl font-black text-[#14232B] md:text-4xl">{copy.safetyTitle}</h2>
            ...
            <div className="rounded-[2.5rem] border border-[#25A77A]/20 bg-[#F8FAF7] p-8 shadow-sm md:p-10">
              <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-[#25A77A] text-2xl text-white">🌿</div>
              <h2 className="text-3xl font-black text-[#14232B] md:text-4xl">{copy.inspirationTitle}</h2>
        ...
        <section id="faq" className="px-5 py-20 lg:px-8">
          <div className="mx-auto max-w-4xl">
            <div className="mb-10 text-center">
              ...
              <h2 className="text-4xl font-black tracking-tight text-[#195C85] md:text-5xl">{copy.faqTitle}</h2>
            </div>

            <div className="space-y-4">
              {copy.faqs.map(([q, a], index) => (
                <div key={q} className="overflow-hidden rounded-3xl border border-[#195C85]/10 bg-white shadow-sm">
                  <button
                  ...
                  {openFaq === index && <p className="px-6 pb-6 leading-8 text-[#14232B]/70">{a}</p>}
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="mx-auto max-w-6xl overflow-hidden rounded-[3rem] bg-[#195C85] text-white shadow-2xl shadow-[#195C85]/20">
            <div className="grid gap-8 p-8 md:p-12 lg:grid-cols-[1.1fr_0.9fr] lg:p-16">
              <div className={align}>
                ...
                <p className="mt-6 max-w-2xl leading-8 text-white/82">{copy.contactText}</p>
              ...
              <div className="rounded-[2rem] bg-white/10 p-6 ring-1 ring-white/15 backdrop-blur">
                <p className="text-sm font-bold uppercase tracking-[0.18em] text-[#7CCBAE]">{copy.needsTitle}</p>
                <ul className="mt-5 space-y-4 text-white/86">
                  {copy.needs.map((need) => <li key={need}>• {need}</li>)}
                </ul>
              </div>
            </div>
          </div>
      ...
      <footer className="border-t border-[#195C85]/10 bg-white px-5 py-10 lg:px-8">
        <div className="mx-auto flex max-w-7xl flex-col gap-8 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-4 max-w-xl text-sm leading-7 text-[#14232B]/65">{copy.footerText}</p>
          </div>

          <div className="flex flex-wrap gap-5 text-sm font-semibold text-[#14232B]/65">
            {copy.nav.map(([label, href]) => (
              <a key={href} href={href} className="hover:text-[#195C85]">{label}</a>
            ))}
          </div>
        </div>
